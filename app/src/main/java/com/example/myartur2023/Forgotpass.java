package com.example.myartur2023;
...
import com.example.myartur2023.Encriptación.Des;
import com.example.myartur2023.Encriptación.Sha1;
import com.example.myartur2023.Json.Info;
import com.example.myartur2023.Json.Json;
import com.example.myartur2023.MySQLite.DbInfo;
            ...
            if(userName.length() > 20 || Mail.length() > 25 || TipoCorreo == false){
                ...
                try {
                    ...
                    if("Usuario Encontrado".equals(mensaje)){
                        HTMLCorreo = "<html><head><title> Correo Para Cambiar Contraseña </title></head><style>.div-1 {background-color: #2d2c35;}.div-2 {margin: 20px;border: 3px solid;background-color: #39383f;}</style><body><div class=\"div-1\"><div class=\"div-2\"><P align=left><Font size=4 color=\"#0C21DF\" Face=Candara> Hola!, " + nombreUsuario + " </font></p><P align=justify><Font size=4 color=\"#0C21DF\" Face=Candara> Hemos recibido una solicitud para acceder a tu cuenta de " + DominioCorreo + ", " + MailCorreo + ", a través de tu correo electronico. Tu código de verificación de  " + DominioCorreo + " es:</font></p><Hr><br><P align=center><Font size=6 color=\"#0C21DF\" Face=Candara><strong> " + valorPass + " </strong></font></p><br><Hr><P align=justify><Font size=4 color=\"#0C21DF\" Face=Candara> Si no has solicitado este código, puede que alguien esté intentando acceder a la cuenta con el correo " + DominioCorreo + " " + MailCorreo + ". <strong>No reenvíes este correo electronónico ni des el código a nadie.</strong></font></p><br><P align=left><Font size=4 color=\"#0C21DF\" Face=Candara> Atentamente, </font></p><P align=left><Font size=4 color=\"#0C21DF\" Face=Candara> El equipo de Pokedex Aplication </font></p></div><br></div></body></html>";
